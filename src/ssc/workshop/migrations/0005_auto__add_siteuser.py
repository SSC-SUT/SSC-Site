...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'workshop_siteuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('studentID', self.gf('django.db.models.fields.CharField')(default='90123456', max_length=8)),
            ('description', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
        ))
        db.send_create_signal(u'workshop', ['SiteUser'])


    def backwards(self, orm):
        # Deleting model 'SiteUser'
        db.delete_table(u'workshop_siteuser')
