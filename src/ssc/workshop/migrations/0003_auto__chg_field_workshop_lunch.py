...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Workshop.lunch'
        db.alter_column(u'workshop_workshop', 'lunch', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Workshop.lunch'
        db.alter_column(u'workshop_workshop', 'lunch', self.gf('django.db.models.fields.TextField')(max_length=50))
